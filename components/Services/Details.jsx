...
const ServiceDetail = ({ slug, details }) => {
    ...
    <>
      ...
      <div className='min-h-screen details'>
        <div className="">
          ...
          <section id="sec6 hatypo3d-section" className="section is-full is-dark _3d relative p-4 sm:p-0" style={{ zIndex: "30" }}>
            <div className="w-layout-blockcontainer  w-container">
              <div className="cta-wrapper">
                <div className="cta-head">
                  <div className="tittle text-18">{data?.sec6?.head || "Have any questions?"}</div>
